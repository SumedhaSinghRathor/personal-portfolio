...
function About() {
  return (
    <div className="w-full min-h-screen max-h-fit flex items-end justify-end p-5 gap-10 text-blue selection:bg-blue selection:text-black">
      <div className="text-end">
        <FontAwesomeIcon icon={faArrowDown} className="-rotate-45 text-8xl" />
