...
function Id() {
  return (
    <div className="bg-blue flex shrink-0 w-2xs h-[450px] p-0 m-0 justify-between rounded-2xl overflow-clip border-2  border-blue select-none">
      ...
      <div className="banner h-inherit">
        <h2
          ...
          className="bg-black text-blue h-full text-2xl text-center font-bold font-mono"
        >
          4th Year, B.Tech CSE
        </h2>
      </div>
